...
public class ShellPrompt {
    ...
    public ShellPrompt(Terminal terminal) {
     ...
     */
    public String getColored(String message, TerminalColor color) {
    ...
    public String getInfoMessage(String message) {
        return getColored(message, TerminalColor.valueOf(infoColor));
    }

    public String getSuccessMessage(String message) {
        return getColored(message, TerminalColor.valueOf(successColor));
    }

    public String getWarningMessage(String message) {
        return getColored(message, TerminalColor.valueOf(warningColor));
    }

    public String getErrorMessage(String message) {
        return getColored(message, TerminalColor.valueOf(errorColor));
    }
    ...
    public void printSuccess(String message) {
        print(message, TerminalColor.valueOf(successColor));
    }
    ...
    public void printInfo(String message) {
        print(message, TerminalColor.valueOf(infoColor));
    }
     ...
     */
    public void print(String message, TerminalColor color) {
